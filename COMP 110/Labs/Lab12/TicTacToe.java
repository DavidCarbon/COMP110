...
public class TicTacToe {
	/** Successfully kill the input scanner once game ends (once this value is true) */
	private static boolean endGameInput = false;
	...
	public static int[] getCell(String[][] m, String t) {
		...
		//Kill Input Thread (Similar to C# background worker, but not really)
		if (endGameInput == true) {
			input.close();
		}
